...
public class PlayerInputs : MonoBehaviourPun
{
    ...
    private bool isMidBash;
    private float lastAngle;
    public float bashPower = 60;
    private GameObject arrow;
    private bool wasNearObject;
    ...
    private float jumpTimeAllowance = 0;

    private CinemachineFramingTransposer vCam;

    private bool elementControllerHasInstantiated = false;
    ...
    private void Update()
    {
        ...
        HandleBashingOrDashing();
        OnSlingshotInputDown();
        controller.Move(velocity * Time.deltaTime, directionalInput);
        HandleVerticalCollisions();
        DrawDebugCollisionRays();
    ...
    private void DrawDebugCollisionRays()
    {
    ...
    private void HandleBashingOrDashing()
    {
        if (isSmashing)
        {
            velocity.x = 0;
    ...
    private void HandleCollisionsBelow()
    {
    ...
    /// </summary>
    private void CheckForSmashableObstacle()
    {
    ...
    /// </summary>
    /// <returns></returns>
    private IEnumerator SmashAnimation()
    {
        float currentRot = 0f;
    ...
    [PunRPC]
    private void TriggerDashResults()
    {
